...
func TestCloseEndpoint_RequiresAuth(t *testing.T) {
	...
	httpServer := CreateHTTPServerForRoutedMode("127.0.0.1:0", us, []string{apiKey}, "")
...
func TestCreateHTTPServerForRoutedMode_ServerIDs(t *testing.T) {
	...
	// Create routed mode server
	httpServer := CreateHTTPServerForRoutedMode("127.0.0.1:8000", us, nil, "")
...
func TestCloseEndpoint_EdgeCases(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			httpServer := CreateHTTPServerForRoutedMode("127.0.0.1:0", us, keysOrNil(tt.apiKey), "")
