...
func TestInitGuardPolicy_InvalidJSON(t *testing.T) {
	...
	require.Error(t, err)
	require.ErrorContains(t, err, "invalid policy JSON")
...
func TestInitGuardPolicy_ValidationFailure(t *testing.T) {
	...
	require.Error(t, err)
	require.ErrorContains(t, err, "policy validation failed")
...
func TestInitGuardPolicy_WriteSinkRejected(t *testing.T) {
	...
	require.Error(t, err)
	require.ErrorContains(t, err, "write-sink policies are not supported")
	assert.False(t, s.guardInitialized)
}
...
func TestInitGuardPolicy_LabelAgentError(t *testing.T) {
	...
	require.ErrorContains(t, err, "guard: wasm runtime error")
	assert.False(t, s.guardInitialized)
}
...
func TestInitGuardPolicy_LabelAgentNilResult(t *testing.T) {
	...
	require.Error(t, err)
	require.ErrorContains(t, err, "nil result")
	assert.False(t, s.guardInitialized)
}
...
func TestInitGuardPolicy_InvalidDIFCModeError(t *testing.T) {
	...
	require.Error(t, err)
	require.ErrorContains(t, err, "invalid difc_mode")
	assert.False(t, s.guardInitialized,
