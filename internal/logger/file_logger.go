...
// (mcp-gateway.log). For destination-specific logging use LogInfoToMarkdown
// or LogInfoToServer.
...
// (mcp-gateway.log). For destination-specific logging use LogWarnToMarkdown
// or LogWarnToServer.
...
// (mcp-gateway.log). For destination-specific logging use LogErrorToMarkdown
// or LogErrorToServer.
...
// (mcp-gateway.log). For destination-specific logging use LogDebugToMarkdown
// or LogDebugToServer.
