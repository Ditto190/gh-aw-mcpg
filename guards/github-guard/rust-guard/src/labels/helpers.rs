...
mod tests {
    ...
    // -------------------------------------------------------------------------
    // extract_repo_from_item — all lookup strategies
    // -------------------------------------------------------------------------
    ...
    #[test]
    fn test_extract_repo_from_item_repository_full_name_fallback() {
        let item = serde_json::json!({ "repository": { "full_name": "owner/repo" } });
        assert_eq!(extract_repo_from_item(&item), "owner/repo");
    }

    #[test]
    fn test_extract_repo_from_item_base_repo_full_name_for_prs() {
        let item = serde_json::json!({ "base": { "repo": { "full_name": "owner/repo" } } });
        assert_eq!(extract_repo_from_item(&item), "owner/repo");
    }

    #[test]
    fn test_extract_repo_from_item_head_repo_full_name_for_fork_prs() {
    ...
    #[test]
    fn test_extract_repo_from_item_full_name_takes_priority_over_nested() {
