...
- Enabled linters: `misspell`, `testifylint`, `unconvert`
...
**testifylint**: Enabled by default and configured with `enable-all: true`.
...
- To run on the entire codebase: `golangci-lint run --enable=testifylint --timeout=5m`
